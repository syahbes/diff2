...
function App() {
  const [dateRef, optionRef, rentRef, includeRef] = [
    "dateRef",
    "optionRef",
    "rentRef",
    "includeRef",
      ...
      <div className="app-container">
        ...
        <div className="display-container">
          ...
          <div style={{ width: "100%" }}>
            ...
            <Typography variant="body2">
            6.1 השוכר מתחייב להשתמש בדירה לצרכי מגורים בלבד ולא לכל צורך אחר. השוכר מתחייב לא למסור, לשעבד או להעביר בכל דרך אחרת את זכויותיו לפי הסכם זה, או להרשות לאחרים להשתמש בדירה או בכל חלק ממנה, בתמורה או שלא בתמורה, ללא הסכמת המשכיר מראש ובכתב. הוראה זו הינה הוראה יסודית והפרתה תיחשב להפרה יסודית של השוכר.
            </Typography>
            <Typography variant="body2">
            6.2 על אף האמור בסעיף 6.1 לעיל השוכר יוכל להשכיר את הדירה בשכירות משנה ("סאבלט") רק לאחר קבלת הסכמה מפורשת בכתב מהמשכיר.
            </Typography>
            <Typography variant="body2">
            6.3 השוכר מתחייב להשתמש בדירה, על מערכותיה, מתקניה ותכולתה, באופן זהיר וסביר, ולשמור על ניקיונה ועל ניקיון הבניין. השוכר לא יעשה בדירה, או בכל חלק ממנה, כל שימוש אשר יכול לגרום נזק, הטרדה או רעש בלתי סבירים, וכן יציית וימלא בדייקנות את כל הוראות החוק, הוראות כל רשות מוסמכת והוראות ועד הבית.
            </Typography>
